...
const CardProject = ({ Img, Title, Description, id }) => {
  ...
  return (
    <div className="group relative w-full h-full">
      <div className="relative h-full overflow-hidden rounded-xl bg-gradient-to-br from-slate-900/90 to-slate-800/90 border border-white/10 shadow-2xl transition-all duration-300 hover:shadow-purple-500/20">
        {/* Optional light gradient overlay, can remove this if you want max clarity */}
