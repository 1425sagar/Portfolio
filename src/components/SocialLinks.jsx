...
import {
  ...
  Twitter,
  Facebook,
  // Removed ExternalLink from here
} from "lucide-react";
import AOS from "aos";
...
const socialLinks = [
  {
    ...
    subText: "@Sagar G",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/sagargukkali46/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@_sagar_vasishta_",
    icon: Instagram,
    url: "https://www.instagram.com/_sagar_vasishta_/?next=%2F&hl=en",
    color: "#E4405F",
  ...
  },
  {
    name: "Twitter",
    displayName: "X",
    subText: "@Sagar_vasishta_",
    icon: Twitter,
    url: "https://x.com/Sagar_vasishta_",
    color: "#05090bff",
  ...
  },
  {
    ...
    subText: "@Sagar1425",
    icon: Github,
    url: "https://github.com/1425sagar",
    color: "#ffffff",
  ...
  },
  {
    ...
    subText: "@Sagar G",
    icon: Facebook,
    url: "https://www.facebook.com/Sagar.g.46/", 
    color: "#5576d7ff",
    gradient: "from-[#3b5998] to-[#1877F2]",
  },
];
...
const SocialLinks = () => {
  ...
  // Corrected destructuring to use 'facebook' instead of 'tiktok'
  ...
  return (
    <div className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
      ...
      <div className="flex flex-col gap-4">
        ...
        >
          ...
          <div className="relative flex items-center gap-4">
            ...
            <div className="flex flex-col">
              <span className="text-lg font-bold text-gray-200 group-hover:text-white">{linkedIn.displayName}</span>
              <span className="text-sm text-gray-400 group-hover:text-gray-300">{linkedIn.subText}</span>
            </div>
          </div>

          {/* Removed ExternalLink here */}
        ...
        {/* GitHub & Facebook */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[github, facebook].map((link, index) => (
            <a
              key={link.name}
              href={link.url}
              target="_blank"
