...
// Memoized Profile Image with gradients and hover effects
...
            src="/Photo.jpg"
            alt="Profile"
            className="w-full h-full object-cover transition-all duration-700 grayscale group-hover:grayscale-0 group-hover:scale-110 group-hover:rotate-2"
            loading="lazy"
          />
...
const AboutPage = () => {
  // Memoized data from localStorage and experience calculation
...
  // Initialize AOS with debounce on resize
  useEffect(() => {
    const initAOS = () => {
      AOS.init({ once: false });
    };
...
  // Stats data memoized for better performance
...
            <p
              className="text-base sm:text-lg lg:text-xl text-white-400 leading-relaxed text-justify pb-4 sm:pb-0"
              data-aos="fade-right"
              data-aos-duration="1500"
            >
              I born and brought up from Chickmagalur.A graduate of Information Science and Engineering from Presidency University who has a great interest in Full-Stack development. I focus on creating engaging digital experiences and always strive to provide the best solutions in every project I work on.
              </p>
...
              <a href="#Resume" className="w-full lg:w-auto">
                <button
                  data-aos="fade-up"
                  data-aos-duration="800"
